...
all_points = line_segment_endpoints.select{|endpoints| horizontal?(endpoints) || vertical?(endpoints)}.map{|endpoints| line_segment_from_endpoints(endpoints)}.flatten(1)
